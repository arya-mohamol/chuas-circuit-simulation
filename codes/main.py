...
# 4
perturbed_cond = [init_cond[0] + 0.00001, init_cond[1], init_cond[2]]
...
ax4.set_title(f"alpha = {alpha_periodic}")
ax4.set_xlabel("X")
ax4.set_ylabel("Y")
...
# 6
plt.figure(figsize=(10, 4))
plt.plot(t_s, nominal_path[:, 1], label='Original', color='navy', lw=1.5)               #main plot
plt.plot(t_s, perturbed_path[:, 1], label='0.00001', color='crimson', linestyle='--', lw=1.2)             # with the slight difference of : 0.00001 
